$(document).ready(function() {
	...
	$(".top_text p, .section_head").animated("fadeInUp", "fadeOutDown");
	$(".cont_text p").animated("fadeInUp");
	$(".ob_item i").animated("rollIn", "rollOut");
	...
	$(".animation_3").animated("flipInY", "flipOutY");

	$(".left .resume_item").animated("fadeInLeft", "flipOutY");
	$(".right .resume_item").animated("fadeInRight", "flipOutX");

	/*встановлює розмір вікна шапки і фіксить при ресайзі */
